/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9c1ab6a5cf1aac095c01a0212646570a)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	SESSION_CACHE: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	BASE_URL: "https://your-domain.com" | "http://localhost:8787";
	ENVIRONMENT: "production" | "development";
	DASHBOARD_URL: "https://your-domain.com" | "http://localhost:5173";
	SESSION_CACHE_TTL_SECONDS: "3600" | "60";
	RATE_LIMITER_SHARDS: "8" | "4";
	METRICS_BUFFER_SHARDS: "8" | "4";
	APP_NAME: "Open LLM Proxy";
	EMAIL_TEMPLATE_CACHE?: DurableObjectNamespace<import("./src/index").EmailingCacheDO>;
	METRICS_BUFFER?: DurableObjectNamespace<import("./src/index").MetricsBuffer>;
	RATE_LIMITER?: DurableObjectNamespace<import("./src/index").RateLimiter>;
	RESPONSE_CACHE?: DurableObjectNamespace<import("./src/index").ResponseCache>;
	SESSION_MANAGER?: DurableObjectNamespace<import("./src/index").SessionManager>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EmailingCacheDO" | "MetricsBuffer" | "RateLimiter" | "ResponseCache" | "SessionManager";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "ENVIRONMENT" | "DASHBOARD_URL" | "SESSION_CACHE_TTL_SECONDS" | "RATE_LIMITER_SHARDS" | "METRICS_BUFFER_SHARDS" | "APP_NAME">> {}
}
